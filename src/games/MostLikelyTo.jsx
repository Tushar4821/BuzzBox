...
import { Sparkles, Flame, GlassWater, Users, Crown } from "lucide-react";
import { mostLikelyToQuestions } from "../data/mostLikelyToData";
...
function MostLikelyTo() {
  ...
  const getRandomQuestion = () => {
    const source = mostLikelyToQuestions[mode];
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-white/65 sm:text-base">
            Point fingers and expose the group.
          </p>
        </motion.div>
            ...
            <div className="relative z-30 text-center">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <button
                  type="button"
                  onClick={() => {
                    console.log("drinking clicked");
                    handleModeSelect("drinking");
                  }}
                  className="relative z-40 pointer-events-auto rounded-3xl border border-pink-500/20 bg-linear-to-br from-pink-500/20 via-purple-500/10 to-transparent p-6 text-left"
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    console.log("non drinking clicked");
                    handleModeSelect("nonDrinking");
                  }}
                  className="relative z-40 pointer-events-auto rounded-3xl border border-blue-500/20 bg-linear-to-br from-blue-500/20 via-cyan-500/10 to-transparent p-6 text-left"
                >
              ...
              <button
                ...
                className="relative z-40 mt-8 text-sm text-white/55 hover:text-white"
              >
                Edit players
              </button>
            </div>
          ...
          {step === "ready" && (
            <div className="relative z-30 text-center">
              ...
              <button
                ...
                className="relative z-40 mt-8 rounded-2xl bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 px-8 py-4 text-base font-semibold text-white"
              >
                Start Round
              </button>
            </div>
            ...
            <div className="relative z-30 text-center">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                <button
                  type="button"
                  onClick={getRandomQuestion}
                  className="relative z-40 rounded-2xl bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 px-6 py-3 text-sm font-semibold text-white"
                >
                  Next Question
                </button>
                ...
                <button
                  ...
                  className="relative z-40 rounded-2xl border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-white/85"
                >
                  Next Player
                </button>
